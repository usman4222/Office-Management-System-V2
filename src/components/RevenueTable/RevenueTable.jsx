                ...
                <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                    <div className='flex md:justify-between  md:flex-row flex-col'>
                        <h4 className="mb-6 text-xl font-semibold text-black dark:text-white">
                            Current Month Revenues List
                        </h4>
                        <h4 className="md:text-xl text-lg mb-5 md:mb-0  flex justify-start md:pb-5 font-semibold text-black dark:text-white">
                            <Link
                                to={"/searchrevenue"}
                                className="inline-flex items-center justify-center gap-3  md:px-10 text-center font-medium text-black dark:text-white hover:underline lg:px-8 xl:px-10"
                            >
                    ...
                    <div className="max-w-full overflow-x-auto">
                        {revenueList && Array.isArray(revenueList.revenueList) && revenueList.revenueList.length > 0 ? (
