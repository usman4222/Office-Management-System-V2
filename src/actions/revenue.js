...
export const addNewRevenue = (revenue) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`https://soriic-b-km2z.vercel.app/api/v1/revenue`, revenue, config);
...
export const getAllRevenue = ({ startDate, endDate }) => async (dispatch) => {
    try {
        ...
        const url = `https://soriic-b-km2z.vercel.app/api/v1/allrevenues?${queryParams}`;
...
export const getRevenueList = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://soriic-b-km2z.vercel.app/api/v1/revenuelist`);
...
export const getTotalRevenueList = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://soriic-b-km2z.vercel.app/api/v1/totalrevenueslist`);
...
export const getCurrentMonthRevenue = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://soriic-b-km2z.vercel.app/api/v1/currentmonthrevenue`);
