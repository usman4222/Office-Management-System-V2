...
export const addNewExpense = (expense) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`https://soriic-b-km2z.vercel.app/api/v1/finance`, expense, config);
...
export const getExpenseList = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://soriic-b-km2z.vercel.app/api/v1/expenselist`);
...
export const getTotalExpenseList = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://soriic-b-km2z.vercel.app/api/v1/totalexpenseslist`);
...
export const getAllExpenses = ({ startDate, endDate }) => async (dispatch) => {
    try {
        ...
        const url = `https://soriic-b-km2z.vercel.app/api/v1/allexpenses?${queryParams}`;
...
export const getCurrentMonthExpenses = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://soriic-b-km2z.vercel.app/api/v1/getExpenses`);
